...
import { ACT_INTROS, CHOICE_TEXT, CHOICE_TEXT_DYNAMIC, OPTION_CONSEQUENCE, OPTION_CONSEQUENCE_DYNAMIC } from './narrative.js?v=4';
import { ACT_BACKDROP, backdropFor } from './assets.js?v=4';
import { computeEnding, epilogueFor } from './endings.js?v=4';
import { renderTitle, renderActIntro, renderChoice, renderConsequence, renderEnding } from './ui.js?v=4';
