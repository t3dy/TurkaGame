...
export const CHOICE_TEXT = {
  ...
  c10: 'Word reaches you plainly, the way this kind of word always does: Shah Rukh has moved against his own nephew. Iskandar Sultan will be blinded, then executed. You are known, by name, as his man — and Shah Rukh\'s own son, Bāysunghur, is the only safe court left standing nearby.',
  ...
  c36: 'Exile begins — five years of it, if the histories are right. The Aqquyunlu hold rival courts not far east; Isfahan is a door that may or may not reopen. The question is not whether you survive it, but what kind of life you build inside it.',
...
export const OPTION_CONSEQUENCE = {
  ...
  c10: { loyal: 'You stay visibly loyal to a man about to lose his eyes and then his life. Reckless by any sane measure — and if you survive it, no one will ever doubt where you stood.', early_defect: 'You distance yourself before the executioner arrives. Prudent — and it leaves nothing behind to call on later.' },
