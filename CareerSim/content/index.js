...
import { PEOPLE, ARTIFACTS } from './people.js?v=1';
import * as P1 from './phase1.js?v=2';
import * as P2 from './phase2.js?v=1';
import * as P3 from './phase3.js?v=1';
import * as P4 from './phase4.js?v=1';
import * as P5 from './phase5.js?v=1';
