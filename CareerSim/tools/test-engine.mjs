...
import { drawEncounter, evaluateOptions, resolveOption, encounterEligible, cairoVerdict, BANDS } from '../src/engine/engine.js?v=8';
import { NODES } from '../content/phase1.js?v=4';
import { PEOPLE, ARTIFACTS, ENCOUNTERS, PHASES, LAST_PHASE } from '../content/index.js?v=12';
import { addObligation, chargeObligations, offerContract, tickContracts, exposureTier, finalVerdict, LEGACY_NOTES } from '../src/engine/career.js?v=9';
...
test('an open contract cannot outlive its phase — settling forces resolution', async () => {
  const { settleContracts } = await import('../src/engine/career.js?v=9');
  const s = newRun();
  offerContract(s, {
